...
/*   Updated: 2019/04/22 13:55:33 by allefebv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "lemin.h"

static int		ft_path_len(t_room *room, t_lem lem)
{
	t_room		*tmp_r;
	t_neighbor	*tmp_n;
	int			len;
...
static t_path	*ft_fill_path(t_path *path, t_room *first, int len, t_lem lem)
{
	int			i;
	t_room		*tmp_r;
	t_neighbor	*tmp_n;
